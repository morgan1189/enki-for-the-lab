...
namespace Enki
{
	...
	*/
	...
	EPuck::EPuck(unsigned capabilities) :
		...
		infraredSensor0(this, Vector(3.0, -0.9),  2.5, -4*M_PI/45.0, 12, 0, 1, &epuckIRSensorModelPtr),
    ...
    infraredSensor2(this, Vector(0.0, -3.3),  2.5, -M_PI/2.0,    12, 0, 1, &epuckIRSensorModelPtr),
		...
		camera(this, Vector(3.7, 0.0), 2.2, 0.0, M_PI/2.0, 180),
		scannerTurret(this, 7.2, 32),
		bluetooth(NULL)
	{
		if (capabilities & CAPABILITY_BASIC_SENSORS)
		{
      //Left only few sensors active - front-front-right, right, left, front-front-left
